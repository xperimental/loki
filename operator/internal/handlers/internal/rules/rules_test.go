...
func TestBuildOptions_WhenMissingRemoteWriteSecret_SetDegraded(t *testing.T) {
	...
	rulerCfg := &lokiv1beta1.RulerConfig{
		TypeMeta: metav1.TypeMeta{
			Kind: "LokiStack",
		},
		ObjectMeta: metav1.ObjectMeta{
		...
		Spec: lokiv1beta1.RulerConfigSpec{
			RemoteWriteSpec: &lokiv1beta1.RemoteWriteSpec{
				Enabled: true,
				ClientSpec: &lokiv1beta1.RemoteWriteClientSpec{
					AuthorizationType:       lokiv1beta1.BasicAuthorization,
	...
	k.GetStub = func(_ context.Context, name types.NamespacedName, out client.Object, _ ...client.GetOption) error {
		_, isRulerConfig := out.(*lokiv1beta1.RulerConfig)
