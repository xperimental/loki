...
func (in *LokiStackStorageStatus) DeepCopyInto(out *LokiStackStorageStatus) {
	*out = *in
	if in.Schemas != nil {
		...
		*out = make([]ObjectStorageStatusSchema, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ObjectStorageStatusSchema) DeepCopyInto(out *ObjectStorageStatusSchema) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ObjectStorageStatusSchema.
func (in *ObjectStorageStatusSchema) DeepCopy() *ObjectStorageStatusSchema {
	if in == nil {
		return nil
	}
	out := new(ObjectStorageStatusSchema)
	in.DeepCopyInto(out)
	return out
}
