...
func (in *LokiStackStorageStatus) DeepCopyInto(out *LokiStackStorageStatus) {
	*out = *in
	...
	if in.AutomaticUpgrade != nil {
		in, out := &in.AutomaticUpgrade, &out.AutomaticUpgrade
		*out = new(ProposedSchemaUpdate)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *ObjectStorageSchemaStatus) DeepCopyInto(out *ObjectStorageSchemaStatus) {
	*out = *in
	out.ObjectStorageSchema = in.ObjectStorageSchema
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProposedSchemaUpdate) DeepCopyInto(out *ProposedSchemaUpdate) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProposedSchemaUpdate.
func (in *ProposedSchemaUpdate) DeepCopy() *ProposedSchemaUpdate {
	if in == nil {
		return nil
	}
	out := new(ProposedSchemaUpdate)
